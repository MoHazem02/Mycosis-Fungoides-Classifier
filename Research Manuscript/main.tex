...
% Adjust column spacing to fit the extra column
\setlength{\tabcolsep}{4pt} 

\begin{tabular}{l c c c c c}
\toprule
 & \multicolumn{2}{c}{\textbf{10$\times$ Model}} & \multicolumn{2}{c}{\textbf{20$\times$ Model}} & \textbf{Late Fusion} \\
\cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-6}
\textbf{Metric} & \textit{Patch} & \textit{Patient} & \textit{Patch} & \textit{Patient} & \textit{Patient} \\
\midrule
Accuracy & 0.6714 & \textbf{0.7714} & 0.6657 & 0.7429 & \textbf{0.7714} \\
F$_2$-Score & 0.7134 & \textbf{0.8482} & 0.6907 & 0.7477 & \textbf{0.8482} \\
Sensitivity & 0.7030 & \textbf{0.8636} & 0.6670 & 0.7273 & \textbf{0.8636} \\
Specificity & 0.7030 & 0.8636 & 0.6670 & 0.7273 & 0.6154 \\
ROC-AUC & 0.7236 & 0.7867 & 0.7420 & \textbf{0.7972} & \textbf{0.7972} \\
\bottomrule
\end{tabular}
\end{table}
